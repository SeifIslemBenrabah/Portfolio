...
export const TestimonialsSection = () => {
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-8 sm:mb-10 lg:mb-0 shrink-0 pt-6 sm:pt-10 lg:pt-0 lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:z-30 lg:pointer-events-none lg:bg-paper/80 lg:backdrop-blur-md lg:p-10 lg:border lg:border-paper-line">
          <div className="flex justify-center">
            <p className="text-ink/40 text-sm font-semibold uppercase tracking-[0.2em] mb-3">
              Testimonials
            </p>
          </div>

          <h2 id="testimonials-heading" className="font-condensed font-black text-ink text-4xl sm:text-6xl leading-[0.95] uppercase text-center transition-colors">
            What our users say
          </h2>
          <p className="text-center mt-5 text-ink/60 text-lg leading-relaxed max-w-sm transition-colors">
